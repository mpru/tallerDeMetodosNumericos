---
title: "Unidad 4 - Aproximación Polinomial Parte II"
...
knitr::include_graphics("Plots/Unidad4_2_g.pdf")
```
...
\column{.85\textwidth}
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("Plots/Unidad4_2_g2.pdf")
```
\columnsend
...
\column{.85\textwidth}
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("Plots/Unidad4_2_g3.pdf")
```
\columnsend
...
knitr::include_graphics("Plots/Unidad4_2_g4.pdf")
```
...
knitr::include_graphics("Plots/Unidad4_2_g5.pdf")
```
...
\column{.85\textwidth}
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("Plots/Unidad4_2_g6.pdf")
```
\columnsend
...
```{r, echo=FALSE, out.width = '85%'}
knitr::include_graphics("Plots/Unidad4_2_g7.pdf")
```
...
\column{.85\textwidth}
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("Plots/Unidad4_2_g8.pdf")
```
\columnsend
...
\column{.85\textwidth}
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("Plots/Unidad4_2_g9.pdf")
```
\columnsend
...
```{r, echo=FALSE, out.width = '85%'}
knitr::include_graphics("Plots/Unidad4_2_g10.pdf")
```

...
knitr::include_graphics("Plots/U4/Unidad4_g1.pdf")
```
\columnsend
...
ggsave("Plots/U4/Unidad4_g1.pdf", g1, width = 4.5, height = 2.5)
...
g2
ggsave("Plots/U4/Unidad4_g2.pdf", g2, width = 4.5, height = 2.5)
...
g3 <- 
    ...
    geom_segment(aes(x = 0, y = polInt(5.2), xend = 5.2, yend = polInt(5.2)),  linetype=2)
g3
ggsave("Plots/U4/Unidad4_g3.pdf", g3, width = 4.5, height = 2.5)
...
ggsave("Plots/U4/Unidad4_g4.pdf", g4, width = 5, height = 3.25)
```
...
knitr::include_graphics("Plots/U4/Unidad4_g2.pdf")
```
...
knitr::include_graphics("Plots/U4/Unidad4_g3.pdf")
```
...
1     & $y_0 + k \Delta y_0 = 0.3538$                  \\[4pt]
2     & $0.3538 + \frac{k(k-1)}{2!}\Delta^2 y_0 = 0.3592$       \\[4pt]
3     & $0.3592 + \frac{k(k-1)(k-2)}{3!}\Delta^3 y_0 = 0.3606$\\[4pt]
4     & $0.3606 + \frac{k(k-1)(k-2)(k-3)}{4!}\Delta^4 y_0 = 0.3611$\\[4pt]
5     & $0.3611 + \frac{k(k-1)(k-2)(k-3)(k-4)}{5!}\Delta^5 y_0 = 0.3613$\\[4pt] \bottomrule
\end{tabular}
\end{table}
...
3     & $0.3606$ & 0.0032 \\[4pt]
4     & $0.3611$ & 0.0018 \\[4pt]
5     & $0.3613$ & 0.0012 \\[4pt] \bottomrule
\end{tabular}
\end{table}
...
knitr::include_graphics("Plots/U4/Unidad4_g4.pdf")
```
\columnsend
...
\column{.7\textwidth}
```{r, echo=FALSE, , out.width = '100%'}
knitr::include_graphics("Plots/U4/lagrej1")
```
\columnsend
...
knitr::include_graphics("Plots/U4/lagrej2")
```
...
```{r, echo=FALSE, , out.width = '100%'}
knitr::include_graphics("Plots/U4/lagrange2.pdf")
```

\column{.5\textwidth}
\centering Un poco más lejos:
```{r, echo=FALSE, , out.width = '100%'}
knitr::include_graphics("Plots/U4/lagrange.pdf")
```
\columnsend
...
knitr::include_graphics("Plots/U4/lagr_ecuacion1.pdf")
```
\columnsend
